...
pub mod payround {
    ...
    pub fn create_task (ctx: Context<CreateTask>, amount: u64, trigger: ClockworkTrigger) -> Result<()> {
        instructions::create_task::handler(ctx, amount, trigger)
    }
    ...
    pub fn start_task (ctx: Context<StartTask>, amount: u64) -> Result<()> {
        instructions::start_task::handler(ctx, amount)
    }
    ...
    pub fn make_transfer (ctx: Context<MakeTransfer>, amount: u64) -> Result<()> {
        instructions::make_transfer::handler(ctx, amount)
    }
